...
export const de: I18nDictionary = {
  ...
  "model.menu.page_indicator": "Seite {current}/{total}",
  ...
  "question.answered_externally": "✅ Von einem anderen Client (GUI) beantwortet",
  "permission.answered_externally": "✅ Berechtigung von einem anderen Client (GUI) bearbeitet",
  ...
  "legacy.models.env_hint": "💡 Um ein Modell in config.yaml zu nutzen:\n",
  ...
  "stt.not_configured":
    "🎤 Spracherkennung ist nicht konfiguriert.\n\nSetze stt.apiUrl und stt.apiKey in config.yaml, um sie zu aktivieren.",
