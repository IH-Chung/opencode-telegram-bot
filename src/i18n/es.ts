...
export const es: I18nDictionary = {
  ...
  "model.menu.page_indicator": "Página {current}/{total}",
  "model.menu.prev_page": "⬅️ Anterior",
  "model.menu.next_page": "Siguiente ➡️",
  "model.menu.page_empty_callback": "No hay modelos en esta página",
  "model.menu.page_load_error_callback": "No se puede cargar esta página. Inténtalo de nuevo.",
  ...
  "question.answered_externally": "✅ Respondido desde otro cliente (GUI)",
  "permission.answered_externally": "✅ Permiso manejado desde otro cliente (GUI)",
  ...
  "legacy.models.env_hint": "💡 Para usar el modelo en config.yaml:\n",
  ...
  "stt.not_configured":
    "🎤 El reconocimiento de voz no está configurado.\n\nConfigura stt.apiUrl y stt.apiKey en config.yaml para habilitarlo.",
